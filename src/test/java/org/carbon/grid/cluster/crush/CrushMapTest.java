...
public class CrushMapTest {
    ...
    public void testDisabledNodes() {
        ...
        dc1.addChild(new Node(19, (short)500));
        Node node501 = new Node(19, (short)501);
        dc1.addChild(node501);
        dc1.addChild(new Node(19, (short)502));
        dc1.addChild(new Node(19, (short)503));

        dc2.addChild(new Node(19, (short)510));
        dc2.addChild(new Node(19, (short)511));
        dc2.addChild(new Node(19, (short)512));
    ...
    private Node buildNodeTree() {
        ...
        dc1.addChild(new Node(19, (short)500));
        dc1.addChild(new Node(19, (short)501));
        dc1.addChild(new Node(19, (short)502));
        dc1.addChild(new Node(19, (short)503));
